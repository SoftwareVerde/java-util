    ...
    public static <T> void setValue(final Object object, final String memberName, final T newValue) {
        ...
        do {
            try {
                ...
                lastException = new RuntimeException("Invalid member name found: "+ object.getClass().getSimpleName() +"."+ memberName);
            }
            catch (final IllegalAccessException e) {
                lastException = new RuntimeException("Unable to access member: "+ object.getClass().getSimpleName() +"."+ memberName);
            }
    ...
    public static <T> T invoke(final Object object, final String methodName, final Object... params) {
        ...
        do {
            try {
                ...
                lastException =  new RuntimeException("Invalid method name found: "+ object.getClass().getSimpleName() +"::"+ methodName);
            }
            catch (final IllegalAccessException e) {
                lastException =  new RuntimeException("Unable to access method: "+ object.getClass().getSimpleName() +"::"+ methodName);
            }
