...
public class Base64UtilTests {
    @Test
    public void should_decode_base64_strings() {
        // Setup
        ...
        // Action
        final byte[] decodedBytes = Base64Util.base64StringToByteArray(input);
    ...
    @Test
    public void should_decode_and_encode_the_same_base64_string() {
        // Setup
        final String input = "";

        // Action
        final byte[] decodedString = Base64Util.base64StringToByteArray(input);
        final String encodedBytes = Base64Util.toBase64String(decodedString);
